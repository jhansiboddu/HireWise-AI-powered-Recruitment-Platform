...
# template_path = os.path.join(os.path.dirname(__file__), "../templates/shortlisted.html")
# print("Looking for template at:", os.path.abspath(template_path))

# shortlister_router = APIRouter()

# # Email config
# conf = ConnectionConfig(
#     MAIL_USERNAME="anupamagampa1@gmail.com",
#     MAIL_PASSWORD="rnna dshn gqby kqnp",  # <- Make sure this is correct
...
# def show_candidates(request: Request, job_id: int = Query(...)):
...
#     conn.close()
#     return templates.TemplateResponse("shortlisted.html", {
#         "request": request,
...
#             recipients=[email],  # just use string, not EmailStr(email)
#             body=f"""
# Hi {name},
...
#         # Update match_results: mark emailed
#         cursor.execute("""
